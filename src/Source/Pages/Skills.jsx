...
import Helper, { RandomBoxShadow, RandomBoxShadow2, RandomGradientColor, ShadowText } from '../Utility/Helper';


function Skills({ height }) {
    const [Skill, setskills] = useState([
        { name: 'React JS', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a7/React-icon.svg/2300px-React-icon.svg.png', doc:"https://react.dev/" },
        { name: 'React Native', logo: 'https://media2.giphy.com/media/RJzm826vu7WbJvBtxX/giphy.gif?cid=6c09b952a5ni6g5m5gi6nuddgxodzu2gd9zuna0vpnh1v7c2&ep=v1_stickers_related&rid=giphy.gif&ct=s', doc: "https://reactnative.dev/" },
        ...
        { name: 'C Language', logo: 'https://cdn.dribbble.com/users/605032/screenshots/2624385/c.gif', doc:"https://www.w3schools.com/c/c_intro.php" },
        ...
        { name: 'Postman', logo: 'https://pingbix.com/wp-content/uploads/2023/02/api-lifecycle.gif', doc: "https://www.postman.com/" }, 
    ...
    return (
        <Box
            ...
            paddingY={{ base: '20px', sm: '20px', md: '40px' }}
        >
                ...
                >
                    ...
                    {Skill.map((sk) => {
                        return <Box
                            ...
                            m={{ base: 'auto', sm: '4', md: '5' }}
                            mt="2"
                            borderRadius={10}
                            px='3'
                            py={5}
                            // background={Helper}
                            boxShadow={RandomBoxShadow2}
                            cursor={'pointer'}
                            onClick={() => {
                        ...
                        >
                            ...
                            <Text textShadow={ShadowText} fontWeight={600} fontSize={18} >{sk.name}</Text>
                        </Box>
                    })}
